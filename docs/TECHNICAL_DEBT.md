...
- Resultado: `activacion-datacenter.sdjf` pasa de 980×5060 (tira) a **2910×1022** (5 fases a lo ancho, roles por color, aristas inter-área cruzando bordes). Tests `test_hier_density.py` (6) + `test_hier_areas.py` (7). Diferido: §I28 (carriles/swimlanes por rol, "solo bajo petición" del spec); §J32 sólo trunca, no maqueta notas externas.
