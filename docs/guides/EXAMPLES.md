...
**Archivo**: `docs/examples/01-iconos-registrados.gag`

Demostración de los tipos de íconos disponibles con gradientes automáticos.

![Íconos registrados](../examples/01-iconos-registrados.svg)
...
**Archivo**: `docs/examples/02-iconos-no-registrados.gag`

Cuando un tipo de ícono no existe, se muestra el **Banana With Tape** (BWT) como indicador visual de ambigüedad.

![Íconos no registrados](../examples/02-iconos-no-registrados.svg)
...
**Archivo**: `docs/examples/03-conexiones.gag`

Demostración de las cuatro direcciones de flechas disponibles.

![Conexiones](../examples/03-conexiones.svg)
...
**Archivo**: `docs/examples/04-gradientes-colores.gag`

Variedad de colores CSS y hexadecimales con gradientes automáticos.

![Gradientes de colores](../examples/04-gradientes-colores.svg)
...
**Archivo**: `docs/examples/05-arquitectura-gag.gag`
...
**Archivo**: `docs/examples/06-waypoints.gag`

Routing complejo usando puntos intermedios explícitos.

![Waypoints](../examples/06-waypoints.svg)
...
**Archivo**: `docs/examples/07-containers.gag`

Agrupación visual de elementos relacionados con contenedores.

![Contenedores](../examples/07-containers.svg)
...
**Archivo**: `docs/examples/08-auto-layout.gag`

Sin coordenadas: el sistema posiciona automáticamente todos los elementos.

![Auto-layout](../examples/08-auto-layout.svg)
...
**Archivo**: `docs/examples/09-proportional-sizing.gag`

Control de tamaños con propiedades `hp` (height) y `wp` (width).

![Proportional sizing](../examples/09-proportional-sizing.svg)
...
**Archivo**: `docs/examples/10-hybrid-layout.gag`

Combinación de auto-layout, sizing proporcional y prioridades.

![Hybrid layout](../examples/10-hybrid-layout.svg)
